...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/yola1107/kratos/v2/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/yola1107/kratos/v2/transport/http/binding")
)
