...
func TestMetadata_Inject(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "https://github.com/yola1107/kratos",
			args: args{"https://github.com/yola1107/kratos", propagation.HeaderCarrier{"mode": []string{"test"}}},
			want: "https://github.com/yola1107/kratos",
		},
	}
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				carrier: propagation.HeaderCarrier{"X-Md-Service-Name": []string{"https://github.com/yola1107/kratos"}},
			},
			want: "https://github.com/yola1107/kratos",
		},
		{
