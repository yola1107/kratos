...
// */
//
// // FindBestMoveSequence1 计算较优得分路径
// func FindBestMoveSequence1(c *Board, dices []int32, color int32) (int32, int32) {
...
// 		}
// 		if score := c.evaluateMoveSequence(steps, totalDiceSum, color); score > bestScore {
// 			bestScore = score
