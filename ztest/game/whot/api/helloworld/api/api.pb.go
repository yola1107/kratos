...
const (
	...
	// 客户端请求（20~39）
	GameCommand_MsEmojiReq            GameCommand = 20 //表情请求（EmojiRequest）
	GameCommand_MsChatReq             GameCommand = 21 //聊天请求（ChatMsg）
	GameCommand_MsUserActionReq       GameCommand = 22 //玩家操作请求
	GameCommand_MsLeaveRoomReq        GameCommand = 23 //退出房间请求
	GameCommand_MsMasterStart         GameCommand = 24 //房主强制开始游戏  空 -> BaseResponse
	GameCommand_MsPrivateRoomLeaveReq GameCommand = 25 //未开始时，玩家请求退出私有房间（房主则解散房间，非房主则离开）
	// 服务器响应（120~139）
	GameCommand_MsEmojiRsp            GameCommand = 120 //表情广播（BaseResponse）
	GameCommand_MsChatRsp             GameCommand = 121 //聊天广播（ChatMsg）
	GameCommand_MsUserActionRsp       GameCommand = 122 //玩家操作响应
	GameCommand_MsLeaveRoomRsp        GameCommand = 123 //退出房间响应
	GameCommand_MsPrivateRoomLeaveRsp GameCommand = 125 //响应房间退出/解散请求
)
...
var (
	GameCommand_name = map[int32]string{
		...
		23:  "MsLeaveRoomReq",
		24:  "MsMasterStart",
		25:  "MsPrivateRoomLeaveReq",
		120: "MsEmojiRsp",
		121: "MsChatRsp",
		122: "MsUserActionRsp",
		123: "MsLeaveRoomRsp",
		125: "MsPrivateRoomLeaveRsp",
	}
	GameCommand_value = map[string]int32{
		...
		"MsLeaveRoomReq":        23,
		"MsMasterStart":         24,
		"MsPrivateRoomLeaveReq": 25,
		"MsEmojiRsp":            120,
		"MsChatRsp":             121,
		"MsUserActionRsp":       122,
		"MsLeaveRoomRsp":        123,
		"MsPrivateRoomLeaveRsp": 125,
	}
)
...
type RoomInfoPush struct {
	...
	SN            int64                  `protobuf:"varint,11,opt,name=SN,proto3" json:"SN,omitempty"`                                // 6位数房间号 (私有房间创建房间时生成)
...
func (x *RoomInfoPush) GetSN() int64 {
	if x != nil {
		return x.SN
	}
	return 0
...
const file_helloworld_api_api_proto_rawDesc = "" +
	"\n" +
	"\x18helloworld/api/api.proto\x12\x03api\"\xe5\x02\n" +
	"\fRoomInfoPush\x126\n" +
	"\n" +
	...
	"\tgameState\x18\n" +
	" \x01(\x05R\tgameState\x12\x0e\n" +
	"\x02SN\x18\v \x01(\x03R\x02SN\"\xc3\x02\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x12\x10\n" +
	"\x03uid\x18\x03 \x01(\x03R\x03uid\"_\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg*\xfb\x02\n" +
	"\vGameCommand\x12\b\n" +
	...
	"\x0eMsLastCardPush\x10\a\x12\x0e\n" +
	"\n" +
	"MsEmojiReq\x10\x14\x12\r\n" +
	"\tMsChatReq\x10\x15\x12\x13\n" +
	"\x0fMsUserActionReq\x10\x16\x12\x12\n" +
	"\x0eMsLeaveRoomReq\x10\x17\x12\x11\n" +
	"\rMsMasterStart\x10\x18\x12\x19\n" +
	"\x15MsPrivateRoomLeaveReq\x10\x19\x12\x0e\n" +
	"\n" +
	"MsEmojiRsp\x10x\x12\r\n" +
	"\tMsChatRsp\x10y\x12\x13\n" +
	"\x0fMsUserActionRsp\x10z\x12\x12\n" +
	"\x0eMsLeaveRoomRsp\x10{\x12\x19\n" +
	"\x15MsPrivateRoomLeaveRsp\x10}*I\n" +
	"\x06ACTION\x12\x0f\n" +
...
var file_helloworld_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_helloworld_api_api_proto_goTypes = []any{
	...
	(*EmojiRequest)(nil),        // 22: api.EmojiRequest
	(*ChatMsg)(nil),             // 23: api.ChatMsg
	(*PrivateRoomLeaveReq)(nil), // 24: api.PrivateRoomLeaveReq
	(*PrivateRoomLeaveRsp)(nil), // 25: api.PrivateRoomLeaveRsp
	(*BaseResponse)(nil),        // 26: api.BaseResponse
}
