...
type Log struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Mode          int32                  `protobuf:"varint,1,opt,name=mode,proto3" json:"mode,omitempty"`  // 0:"dev" 1:"prod"
	Level         string                 `protobuf:"bytes,2,opt,name=level,proto3" json:"level,omitempty"` // "debug", "info", ...
	Directory     string                 `protobuf:"bytes,3,opt,name=directory,proto3" json:"directory,omitempty"`
	Sensitive     []string               `protobuf:"bytes,4,rep,name=sensitive,proto3" json:"sensitive,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Log) GetDirectory() string {
	if x != nil {
		return x.Directory
	}
	return ""
...
func (x *Log) GetSensitive() []string {
	if x != nil {
		return x.Sensitive
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"k\n" +
	"\x03Log\x12\x12\n" +
