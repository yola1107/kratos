...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/yola1107/")
	...
	if !reflect.DeepEqual(value1, "https://github.com/yola1107/") {
		t.Errorf("expect %v, got %v", "https://github.com/yola1107/", value1)
	}
