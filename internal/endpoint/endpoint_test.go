...
func TestNewEndpoint(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"https", "github.com/yola1107/kratos/"},
			want: &url.URL{Scheme: "https", Host: "github.com/yola1107/kratos/"},
		},
		{
...
func TestParseEndpoint(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "kratos",
			args:    args{endpoints: []string{"https://github.com/yola1107/kratos"}, scheme: "https"},
			want:    "github.com",
			wantErr: false,
		},
		{
